...
export default class Testimonials extends React.Component {
  ...
  testimonials = [{
      name: "Rashmi Kumar",
      date: "10th July",
      msg: "I was skeptical before hiring them due to covid, but their focus on cook’s <b>hygiene and sanitization</b> in trial got me to subscribe for the monthly plan. Its going great guys.. keep it up!",
      rating: 5,
    ...
    },
    {
      name: "Shalinee Singh",
      date: "4th August",
      msg: "Couldn’t ask for more. I get <b>home cooked food</b> even in the pandemic. Wish you could deliver groceries too with the cook.",
      rating: 4,
    ...
    },
    {
      name: "Utkarsh Tiwari",
      date: "19th July",
      msg: "We hired a cook from them. It has been two months now and I think it was a good decision. Chefed delivers on its promise of providing <b>reliable cooks.</b>",
      rating: 5,
            ...
            className = "carousel-container" > {
              this.state.display_content[page].map((testimonial, test_i) => {
                return ( <
                  ...
                  p className = "date my-0 pb-0" > {
                    testimonial.date
                  } < /p> <
                  p className = "date pt-0" > {
                    testimonial.place
                  } < /p> <
                  hr className = "hr" / >
                  <
